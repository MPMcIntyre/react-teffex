...
var Glitch = /** @class */ (function (_super) {
    ...
    function Glitch(props) {
            ...
            if (!_this.state.hasAnimated) {
                var _loop_1 = function (i) {
                    ...
                    var timer = setTimeout(function () {
                        ...
                        if (i === _this.total - 1) {
                            _this.glitchSpeed && _this.glitch();
                        }
                        if (_this.props.reverse) {
        ...
        _this.glitchSpeed = _this.props.glitchSpeed ? _this.props.glitchSpeed : 1;
    ...
    Glitch.prototype.deAnimate = function () {
        var _this = this;
        this.start = 0;
        var _loop_2 = function (i) {
            var text = this_1.state.text;
            var timer = setTimeout(function () {
                // If we reach the buffer, start returning the word
                if (i >= _this.buffer) {
                    text = setCharAt(text, _this.start, _this.generateRandomValue());
                    _this.start++;
                }
                if (i === _this.total - 1) {
                    _this.glitchSpeed && _this.glitch();
    ...
    Glitch.prototype.render = function () {
        var _this = this;
        return (React.createElement("span", { onMouseEnter: function () {
